...
## Survey 1 results
```{r}
treat1 <- subset(survey_1, group == "treatment")
control1 <- subset(survey_1, group == "control")
t.test(treat1$revenue, control1$revenue)
```
...
```{r}
treat2 <- subset(survey_2, group == "treatment")
control2 <- subset(survey_2, group == "control")
t.test(treat2$revenue, control2$revenue)
```
